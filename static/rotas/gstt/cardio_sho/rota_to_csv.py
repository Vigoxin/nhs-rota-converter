...
# Setup
	...
	entries_to_exclude = ['off day', '(off)', 'off', 'AL']
...
# Main
	...
	df = df[ df['Date'].apply(lambda x: type(x) == datetime) ] #Only keep rows where the entry in the 'Date' column is a date
...
if __name__ == '__main__':
	df_result = convert('../../../user_input/input_gstt_cardiology.xlsx', {
		'column_letter': 'I',

...
# Setup
	...
	dates_letnum = 'D' #the column/row which has the dates in it
	entries_to_exclude = ['A/L']
...
if __name__ == '__main__':
	df_result = convert('../../../user_input/input_leicester_royal_infirmary_aande_personalised.xlsx', {
		'sheet_num': '2',
		'column_letter': 'F',
